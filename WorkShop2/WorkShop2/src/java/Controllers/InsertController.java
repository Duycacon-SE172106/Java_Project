...
public class InsertController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String year=request.getParameter("yearOfProduct");
            int yearOfProduct=Integer.parseInt(year);
            String quantityTemp=request.getParameter("quantity");
            int quantity=Integer.parseInt(quantityTemp);
            String notSaleTemp=request.getParameter("notSale");
            ...
            EntitiesDTO product= new EntitiesDTO(mobileId, description, price, mobileName, yearOfProduct, quantity, notSale);
